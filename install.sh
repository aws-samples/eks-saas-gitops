...
# read ssm parameter with CFN feedback info
echo "echo $(aws ssm get-parameter --name \"eks-saas-gitops-custom-resource-event\")" >> /root/.bashrc
echo "echo $(aws ssm get-parameter --name \"eks-saas-gitops-custom-resource-event\")" >> /home/ec2-user/.bashrc
exit
